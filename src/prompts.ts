...
export const pendingReportReviews = (reports: string[]) => `Pending worker revision reviews: ${reports.join("; ")}. Inspect each saved stop report and actual artifacts, then use review_subagent with its reportId. Independent authorized work may continue; attachment receipts and ordinary Intercom messages are not review obligations.`;
